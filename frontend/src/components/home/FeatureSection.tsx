    ...
    <div className="py-12 bg-surface-50 dark:bg-surface-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          ...
          <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-surface-900 dark:text-white sm:text-4xl">
            ...
            {features.map((feature) => (
              <div key={feature.name} className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-surface-900 dark:text-white">
                    {feature.name}
                  </p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-surface-500 dark:text-surface-400">
                  {feature.description}
                </dd>
              </div>
            ))}
